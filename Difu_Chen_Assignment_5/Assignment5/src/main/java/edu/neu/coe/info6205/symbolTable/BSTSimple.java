package main.java.edu.neu.coe.info6205.symbolTable;
...
public class BSTSimple<Key extends Comparable<Key>, Value> implements BSTdetail<Key, Value> {
    ...
    public static void main(String [] args) {
    	...
    	Random jud = new Random();
      
    	for(int h=2000; h<=10000; h+=100) {
    		   BSTSimple<String, Integer> bst = new BSTSimple<>();
    	    	Map<String, Integer> map = new HashMap<>();
    	for (int i = 0; i<h; i++) {
            String key =  String.valueOf(random.nextInt(h));
       ...
       bst.putAll(map);
        ...
        /* for(int k=0;k<1000*h;k++) {
          String key = String.valueOf(rand.nextInt(2*h));
     ...
     //  System.out.println("total elements:"+ h +";  "+"height:"+bst.height()+" lg(h):"+Math.log(h)+" sqrt(h):"+Math.sqrt(h));
